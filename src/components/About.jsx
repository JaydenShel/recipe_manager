...
function About(){
    return(
        <div className="about-container">
            ...
            simplify and organize your favorites recipes. We achieve this by allowing the user to create a
            personalized account and import their own unique recipes that can be easily sorted. 
            </p>
        </div>
    )
}
